...
const glyphs: Readonly<Record<string, string>> = { lpr_camera: "CAM", bus_gps: "BUS", env_multi: "ENV", signal_ctrl: "SIG" };

export function getDeviceIcon(input: { typeCode: string; online: boolean; alertLevel: string; selected: boolean }): DivIcon {
...
export function clearDeviceIconCache(): void { cache.clear(); }
