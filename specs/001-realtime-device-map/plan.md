...
**Testing**: Vitest, React Testing Library, fake timers cho polling/motion, Axios mocking cho contract,
Playwright cho luồng bản đồ end-to-end và kiểm thử hiệu năng bằng fixture 2.000–5.000 thiết bị
...
thiết bị và hướng tới 60 fps ở mật độ viewport thông thường
...
hợp lệ, track lấy vị trí đang hiển thị làm điểm đầu và vị trí mới làm đích, retarget mà không snap.
Thời lượng dựa trên khoảng cách, tốc độ và khoảng thời gian quan sát, cap gần chu kỳ GPS năm giây.
Không ngoại suy vô hạn quá fix xác nhận. Static/fixed, tốc độ gần zero, tọa độ lỗi hoặc GPS void sẽ
không animate. Background tab/resume, reduced motion và jump phi thực tế đều snap an toàn tới đích.
