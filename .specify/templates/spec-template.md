...
- **Owning Feature**: [Name the `src/features/<feature>/` boundary that owns this work]
...
- **Realtime/Geo Scale**: [If applicable, define behavior for 2,000+ devices, viewport bounds,
  polling cadence, prior-request cancellation with AbortController, stale responses, and disposal;
  otherwise state N/A]
...
- **SC-005**: [When realtime/geo applies, measurable evidence that interaction and network behavior
  meet the 2,000-device target; otherwise N/A]
